---
name: Packet Radio (Direwolf TNC) integration
description: Remote Direwolf TNC on FTM-150 Pi endpoint, APRS decode working, Winlink/BBS next
type: project
---

## Packet Radio — Status (2026-04-03)
...
### Key files
- `packet_radio.py` — KISS client, APRS parser, endpoint mode controller
- `gateway_link.py` — AIOCPlugin with audio/data mode, Direwolf subprocess, log forwarding
- `web_pages/packet.html` — UI with Direwolf log panel, APRS map, relay path lines
...
### Next steps
- Phase 4: Winlink (Pat client via KISS TCP to remote Direwolf)
- Phase 5: BBS terminal (AX.25 connected mode via KISS)
